...
public class CustomProfile implements QuarkusTestProfile {
	...
	public Map<String, String> getConfigOverrides() {
		return Map.of("platypus.job.enables", "false", "platypus.remote.server", "localhost",
				...
				"quarkus.http.port", "8443", "quarkus.micrometer.enabled", "false", "quarkus.log.handler.gelf.enabled",
